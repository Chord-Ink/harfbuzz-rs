...
See the "Working with Context Sets" section of the depend API documentation,
[`docs/depend-api.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-api.md),
in the HarfBuzz repository, for details on the context_set encoding and how to
...
closure in
[`test/fuzzing/hb-depend-closure-parity.cc`](https://github.com/harfbuzz/harfbuzz/blob/main/test/fuzzing/hb-depend-closure-parity.cc).
The `compute_depend_closure()` function demonstrates proper handling of:
...
For detailed API documentation, see these files in the HarfBuzz repository:
- [`docs/depend-api.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-api.md) - API usage guide with examples
- [`docs/depend-implementation.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-implementation.md) - Implementation details and architecture

For reference implementation:
- [`test/fuzzing/hb-depend-closure-parity.cc`](https://github.com/harfbuzz/harfbuzz/blob/main/test/fuzzing/hb-depend-closure-parity.cc) - Production-quality closure computation
- [`test/api/test-ot-depend.c`](https://github.com/harfbuzz/harfbuzz/blob/main/test/api/test-ot-depend.c) - Unit tests for depend API
