...
a subset with the source face. The `BM_subset` benchmarks below are defined in HarfBuzz's
[`perf/benchmark-subset.cc`](https://github.com/harfbuzz/harfbuzz/blob/main/perf/benchmark-subset.cc).
