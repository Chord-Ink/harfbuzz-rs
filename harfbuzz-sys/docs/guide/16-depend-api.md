...
*Adapted from the HarfBuzz 14.3.0 documentation, which is licensed under the terms in the HarfBuzz [COPYING](https://github.com/harfbuzz/harfbuzz/blob/main/COPYING) file.*
...
You can also view all available options in the source file
[`meson_options.txt`](https://github.com/harfbuzz/harfbuzz/blob/main/meson_options.txt).
...
HarfBuzz's subset API, see `compute_depend_closure()` in
...
and [`docs/depend-for-closure.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-for-closure.md).
...
`compute_depend_closure()` function in
[`test/fuzzing/hb-depend-closure-parity.cc`](https://github.com/harfbuzz/harfbuzz/blob/main/test/fuzzing/hb-depend-closure-parity.cc).
...
see the "COLR Cycles and Self-References" section in
[`docs/depend-implementation.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-implementation.md).
