...
To compute closures using the extracted graph, see
[`docs/depend-for-closure.md`](https://github.com/harfbuzz/harfbuzz/blob/main/docs/depend-for-closure.md)
in the HarfBuzz repository, which documents how to implement closure by iteratively
following edges in the dependency graph with appropriate filtering.
...
Paths below are relative to the root of the [HarfBuzz source tree](https://github.com/harfbuzz/harfbuzz).
